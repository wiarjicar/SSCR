          ...
          <table width="700" height="138" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td>&nbsp;</td>
                ...
                <form id="form2" name="form2" method="post" action="../controlador/validarProveedor.php">
            <table width="700" height="220" cellpadding="0" cellspacing="4">
              ...
              <tbody>
                <tr>
                  <td width="60"></td>
                  <td width="85">&nbsp;</td>
                  <td width="172" align="right"><em><strong>Nit:</strong></em></td>
                  <td width="46"><label for="nit"></label><input type="number" name="nit" id="apellidos " required /></td>
                  <td width="96" align="right"><em><strong>Empresa:</strong></em></td>
                  <td width="184"><label for="pnombre"></label><input type="text" name="pnombre" id="nombres" required></td>
                </tr>
                <tr>
                  <td width="60" height="35"><a href="modificarProveedor.php" class="link1">
                    <div class="Aceptar"  >
                      <p>Lista</p>
                    </div>
                  </a></td>
                  ...
                  <td ><label for="email"></label><input type="email" name="pemail" id="pemail "required /></td>
                  <td align="right"><em><strong>Direccion:</strong></em></td>
                  <td><label for="direccion"></label><input type="text" name="pdireccion" id="pdireccion "required></td>
                </tr>
                <tr>
                  ...
                  <td align="left"><label for="identificacion">
                          <input type="text" name="pdescripcion" id="pdescripcion" required/>
                  </label></td>
                  <td align="right"><em><strong>Telefono:</strong></em></td>
                  <td><label for="telefono"></label>
                      <input type="number" name="ptelefono" id="ptelefono " required></td>
                </tr>
                <tr>
                  <td> </td>
                  <td>&nbsp;</td>
