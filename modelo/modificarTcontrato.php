...
$sql="select t.idTipoContrato, t.tipCodigo, t.tipTcontrato, t.tipDescripcion
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <table width="585" height="220" cellpadding="0" cellspacing="4">
              ...
              <tbody>
                <tr>
                  <td width="49">&nbsp;</td>
                  <td width="1">&nbsp;</td>
                  <td width="203" align="left"><a href="../Reportes/reporteTipoContrato.php" class="link1" target="_blank" >Generar PDF</a></td>
                  <td width="76">&nbsp;</td>
                  <td> </td>
                  <td width="51">&nbsp;</td>
                </tr>
                <tr>
                  <td width="49" height="35"><a href="frmTipoContrato.php" class="link1">
                    <div class="Aceptar"  >
                      <p>Agregar</p>
                    </div>
                  </a></td>
                   ...
                   <table width="554" height="90" border="1" cellpadding="1" cellspacing="1">
                    <tbody>
                      <tr align="center" bgcolor="#0902A3">
                        <td width="156" height="53" align="center">Codigo</td>
                        <td width="110" align="center">Tipo Contrato</td>
  ...
  while ($tipocontrato = $resultado->fetch_object())
  {
	?>
                           <tr align="center" bgcolor="#FFFFFF">
                           <td height="32"> <?php  echo $tipocontrato->tipCodigo    ?> </td>
                           <td> <?php  echo $tipocontrato->tipTcontrato  ?> </td>
                           <td> <?php  echo $tipocontrato->tipDescripcion   ?> </td>
        <td align="center"><a href="../modelo/frmActualizarTcontrato1.php?idTipoContrato=<?php echo $tipocontrato->idTipoContrato?>"><img src="../vista/Imagenes/actualizar.jpg" 
        
        width="22" height="23" /></a></td>
        
        
                           <td align="center"><a href="../controlador/eliminarTcontrato.php?idTipoContrato=<?php echo $tipocontrato->idTipoContrato?>"><img src="../vista/Imagenes/eliminar1.png" 
...
if ($_REQUEST['x']==2)
	echo 'Problemas al actualizar el Tipo de Contrato...';	
if ($_REQUEST['x']==3)
	echo 'Se ha eliminado el Tipo de Contrato correctamente...';
if ($_REQUEST['x']==4)
	echo 'Problemas al eliminar el Tipo de Contrato...';
if ($_REQUEST['x']==5)
	echo 'Se ha Agregado el Tipo de Contrato correctamente...';
if ($_REQUEST['x']==6)
	echo 'Problemas por Agregar el Tipo de Contrato por favor verificar...';
