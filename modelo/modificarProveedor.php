...
$sql="select p.idProveedor, p.proNit, p.proNombre, p.proDescripcion, p.proDireccion, p.proEmail, p.proTelefono from proveedor p ";
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="700" height="138" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="277"><div class="actini">
                <p><img src="../vista/Imagenes/logo-proveedor.png" width="50" align="center" valign="middle" height="35" alt="50"/>Proveedor</p>
              </div></td>
            ...
            <table width="585" height="220" cellpadding="0" cellspacing="4">
              ...
              <tbody>
                <tr>
                  <td width="49">&nbsp;</td>
                  <td width="1">&nbsp;</td>
                  <td width="203" align="left"><a href="../Reportes/reporteProveedor.php" class="link1" target="_blank" >Generar PDF</a></td>
                  <td width="76">&nbsp;</td>
                  <td></td>
                  <td width="51">&nbsp;</td>
                </tr>
                <tr>
                  <td width="49" height="35"><a href="frmProveedor.php" class="link1">
                    <div class="Aceptar"  >
                      <p>Agregar</p>
                    </div>
                  </a></td>
                   ...
                   <table width="607" height="180" border="1" cellpadding="1" cellspacing="1">
                    <tbody>
                      <tr align="center" bgcolor="#0902A3">
                        <td width="123" align="center">Empresa</td>
                        <td width="89" align="center">Direccion</td>
                        <td width="73" align="center">Telefono</td>
                        <td width="100" align="center">Email</td>
                        <td width="102" align="center">Descripcion</td>
                        <td width="36" align="center">Editar</td>
  ...
  while ($proveedor = $resultado->fetch_object())
  {
	?>
        ...
        <td> <?php  echo $proveedor->proDireccion  ?> </td>
        <td><?php  echo $proveedor->proTelefono  ?></td>
        <td><?php  echo $proveedor->proEmail  ?></td>
        <td><?php  echo $proveedor->proDescripcion  ?></td>
        
        
        <td align="center"><a href="../modelo/frmActualizarProveedor1.php?idProveedor=<?php echo $proveedor->idProveedor?>"><img src="../vista/Imagenes/actualizar.jpg"      
        width="22" height="23" /></a></td>
        
        
        <td align="center"><a href="../controlador/eliminarProveedor.php?idProveedor=<?php echo $proveedor->idProveedor?>"><img src="../vista/Imagenes/eliminar1.png" 
