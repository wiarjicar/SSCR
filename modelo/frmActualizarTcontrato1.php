...
$sql="select * from tipocontrato where idTipoContrato = '$_REQUEST[idTipoContrato]'";
$resultadoTipoContrato = $objConexion->query($sql);

$tipocontrato = $resultadoTipoContrato->fetch_object();
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="4" rowspan="4" align="center" valign="top">
                  	<form id="form1" name="form1" method="post" action="../controlador/validarActualizarTcontrato.php">
  <table width="42%" border="0" align="center">
    <tr>
      <td colspan="2" align="center" bgcolor="#0902A3">ACTUALIZAR TIPO CONTRATO</td>
    </tr>
    <tr>
      <td width="37%" align="right" bgcolor="#EAEAEA">Codigo</td>
      <td width="63%"><label for="codigo"></label>
      
      <input name="codigo" type="text" id="codigo" value="<?php echo $tipocontrato->TipCodigo ?>" size="40" />
      
      </td>
    </tr>
    <tr>
      <td width="37%" align="right" bgcolor="#EAEAEA">Tipo Contrato</td>
      <td width="63%"><label for="contrato"></label>
      
      <input name="contrato" type="text" id="contrato" value="<?php echo $tipocontrato->TipTcontrato ?>" size="40" />
      ...
      <input name="descripcion" type="text" id="descripcion" value="<?php echo $tipocontrato->TipDescripcion?>" size="40" /></td>
    </tr>
    <tr>
  ...
  <input name="idTipoContrato" type="hidden" value="<?php echo $_REQUEST['idTipoContrato'] ?>" />
